package funkin.objects.animateatlas;
...
import funkin.objects.animateatlas.displayobject.SpriteAnimationLibrary;
import funkin.objects.animateatlas.displayobject.SpriteMovieClip;
import funkin.data.*;
