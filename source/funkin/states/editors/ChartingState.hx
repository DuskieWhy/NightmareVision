...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	function addVisualsUI():Void
	{
		...
		var uiBoxTxt = new FlxUIInputText(10, 175, 150,
	...
	override function update(elapsed:Float)
	{
		...
		if (FlxG.mouse.overlaps(clickForInfo))
		{
			...
			if (FlxG.mouse.justPressed)
			{
				...
				FlxTween.color(textBox, 0.75, FlxColor.BLACK,
					FlxColor.fromRGB(ClientPrefs.editorUIColor.red, ClientPrefs.editorUIColor.green, ClientPrefs.editorUIColor.blue), {ease: FlxEase.quartOut});
...
class ChartingInfoSubstate extends MusicBeatSubstate
{
	...
	override public function update(elapsed:Float)
	{
		...
		if (FlxG.keys.justPressed.ESCAPE)
		{
			...
			FlxTween.color(ChartingState.textBox, 0.75,
				FlxColor.fromRGB(ClientPrefs.editorUIColor.red, ClientPrefs.editorUIColor.green, ClientPrefs.editorUIColor.blue), FlxColor.BLACK,
