...
class NoteAnimations
{
    ...
    public static function addNewKey(note:String, sustain:String, sustainEnd:String, receptor:String, receptorPress:String, receptorConfirm:String, singAnimation:String, splash:String)
    {
        notes.push(note);
