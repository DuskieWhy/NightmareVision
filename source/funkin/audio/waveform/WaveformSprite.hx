			...
			for (i in startIndex...endIndex)
			{
				...
				if (clipRect != null)
				{
					if (orientation == HORIZONTAL)
					{
						...
						vertexBottomIndex = buildClippedVertex(pixelPos, vertexBottomY, topLeftVertexIndex, topRightVertexIndex, bottomLeftVertexIndex, bottomRightVertexIndex);
					}
					else
					{
						...
						vertexBottomIndex = buildClippedVertex(vertexBottomY, pixelPos, topLeftVertexIndex, topRightVertexIndex, bottomLeftVertexIndex, bottomRightVertexIndex);
					}
				}
				else
				{
